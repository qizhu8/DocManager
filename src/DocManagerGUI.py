...
class DocManagerGUI(tk.Tk, object):
    ...
    def __init_document_info_frame(self):
        ...
        self.document_info_ctl_dict['typeEntry'].grid(row=0, column=1, sticky='we')
        ...
        self.document_info_ctl_dict['titleEntry'].grid(row=1, column=1, sticky='we')
        ...
        self.document_info_ctl_dict['docIdEntry'].grid(row=2, column=1, sticky='we')

        # description
        self.document_info_ctl_dict['descLabel'] = tk.Label(self.document_info_frame, text="description:")
        self.document_info_ctl_dict['descText'] = tk.Text(self.document_info_frame)

        self.document_info_ctl_dict['descLabel'].grid(row=3, column=0)
        self.document_info_ctl_dict['descText'].grid(row=3, column=1, sticky='we')
        ...
        self.document_info_ctl_dict['connText'] = tk.Text(self.document_info_frame)

        self.document_info_ctl_dict['connLabel'].grid(row=6, column=0)
        self.document_info_ctl_dict['connText'].grid(row=6, column=1, sticky='we')
    ...
    def __layout_frames(self):
        ...
        self.document_list_frame.pack(side=tk.LEFT, fill=tk.BOTH)
        self.document_list_frame.pack_propagate(0)

        self.document_info_frame.config(width=self.windowsParam['GUI_WIDTH']*0.5)
        self.document_info_frame.pack(side=tk.LEFT, fill=tk.BOTH)
